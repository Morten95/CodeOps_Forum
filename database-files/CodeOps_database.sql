...
--
-- Host: localhost
-- Generation Time: Oct 07, 2018 at 03:52 PM
...
(198, 'Jostein97', '$2y$10$jtehiImGbPPlz1kX8c0DQeZQJAdrVXdb488fMxkMUhIHedAqgMafa', 'example@gamil.com', 'John', 'Test', 0, 0);
...
--
ALTER TABLE `Comment`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=469;
...
--
ALTER TABLE `User`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
